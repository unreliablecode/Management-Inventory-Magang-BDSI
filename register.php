...
<body>
  ...
  <img src="logo.png" alt="Login Image" class="login-image"/>
    <!-- <h1>Hello!</h1> -->
    <p class="login-motd">IT Department Inventory Manager Registration</p>
    ...
    <form action="" method="POST">
      ...
      <div class="form-group">
        <input id="password" class="login-password" type="password" placeholder="Confirm Password" name="confirm_password" />
    ...
    <a href="login.php" class="login-forgotpassword">Have an account? Login..</a>
  </div>
